 ...
 */
final class Version20241203184307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE linea_pedido (id INT AUTO_INCREMENT NOT NULL, pedido_id INT DEFAULT NULL, articulo_id INT DEFAULT NULL, cantidad INT NOT NULL, INDEX IDX_183C31654854653A (pedido_id), INDEX IDX_183C31652DBC2FC9 (articulo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
