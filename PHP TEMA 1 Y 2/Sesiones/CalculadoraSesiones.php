...
if (!isset($_SESSION["resultadosCont"])) {
    // La creamos como un array vacio
    $_SESSION["resultadosCont"] = array();
}

if (isset($_REQUEST["accion"])) {
    $resultadoCont = $_REQUEST["memoria_resultado"];
    // y lo añadimos al array carrito
    array_push($_SESSION["resultadosCont"], $resultadoCont);
    // Mostramos el array carrito
    var_dump($_SESSION["resultadosCont"]);
}
...
<body>
    ...
    <form action="#" align="center" method="GET">
        ...
        <input type="hidden" name="memoria_resultado" value="<?php echo $resultado; ?>">
